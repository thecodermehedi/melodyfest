...
const About = () => {
  return (
    <section className="min-h-screen bg-[#181A1B]  p-5 md:p-10 lg:p-20">
      ...
      <div className="block lg:flex justify-between items-center my-10">
        <p className="font-bold text-white text-opacity-50  md:text-lg  w-80 md:w-full mb-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 place-items-center lg:place-items-start gap-10">
        <div className="w-full h-fit lg:h-[21rem] bg-black bg-opacity-50 rounded-2xl p-8">
          ...
          <p className=" text-lg md:text-xl lg:text-2xl font-semibold text-white text-opacity-50">
